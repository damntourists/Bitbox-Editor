...
// Ease matches the C++ template dispatcher; pass float32 params as needed per mode.
func Ease(mode EaseMode, params ...float32) float32 {
	switch mode {
	case EaseInOutQuad:
